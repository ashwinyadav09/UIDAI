...
try:
    ...
    # Save figure
    plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'STEP6_trends_top10_states.png'), 
...
try:
    ...
    # Save
    plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'STEP6_update_rates_comparison.png'), 
                dpi=300, bbox_inches='tight')
    plt.close()
