...
capacity_planning = pd.read_csv(os.path.join(PROJECT_PATH, 'results', 'STEP10_ENHANCED_capacity_planning.csv'))
enrolment_metrics = pd.read_csv(os.path.join(PROJECT_PATH, 'results', 'STEP10_ENHANCED_enrolment_metrics.csv'))
biometric_metrics = pd.read_csv(os.path.join(PROJECT_PATH, 'results', 'STEP10_ENHANCED_biometric_metrics.csv'))
...
# Save models
with open(os.path.join(PROJECT_PATH, 'results', 'STEP11_bottleneck_model.pkl'), 'wb') as f:
    pickle.dump(bottleneck_model, f)

with open(os.path.join(PROJECT_PATH, 'results', 'STEP11_age_targeting_model.pkl'), 'wb') as f:
    pickle.dump(age_targeting_model, f)

with open(os.path.join(PROJECT_PATH, 'results', 'STEP11_capacity_model.pkl'), 'wb') as f:
    pickle.dump(capacity_model, f)

# Save results
features_df.to_csv(os.path.join(PROJECT_PATH, 'results', 'STEP11_bottleneck_predictions.csv'), index=False)
age_group_df.to_csv(os.path.join(PROJECT_PATH, 'results', 'STEP11_age_group_targeting.csv'), index=False)
capacity_features.to_csv(os.path.join(PROJECT_PATH, 'results', 'STEP11_capacity_predictions.csv'), index=False)
feature_importance.to_csv(os.path.join(PROJECT_PATH, 'results', 'STEP11_feature_importance.csv'), index=False)
...
with open(os.path.join(PROJECT_PATH, 'results', 'STEP11_model_performance.pkl'), 'wb') as f:
