...
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_01_state_update_heatmap.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_02_enrolment_trends.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_03_biometric_trends.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_04_age_distribution.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_05_child_gap.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
ax.grid(axis='x', alpha=0.3)
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_06_compliance.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
ax.grid(axis='y', alpha=0.3)
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_07_anomalies.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
fig, ax = plt.subplots(figsize=(16, 10))
cap_data = step10_cap.sort_values('growth_3m_pct_enrol', ascending=True)

x = np.arange(len(cap_data))
width = 0.35

ax.barh(x - width/2, cap_data['growth_3m_pct_enrol'], width, label='Enrolment Growth', color='#4A90E2', edgecolor='black', linewidth=1.5)
ax.barh(x + width/2, cap_data['growth_3m_pct_bio'], width, label='Biometric Growth', color='#50C878', edgecolor='black', linewidth=1.5)
...
ax.grid(axis='x', alpha=0.3)
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_08_capacity.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_09_bottleneck.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
...
ax.grid(axis='y', alpha=0.3)
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_PATH, 'visualizations', 'DASHBOARD_10_age_targeting.png'), dpi=300, bbox_inches='tight')
print("✓ Saved")
plt.close()
