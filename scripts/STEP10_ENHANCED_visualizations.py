...
with open('../results/STEP10_ENHANCED_models.pkl', 'rb') as f:
    data = pickle.load(f)
...
plt.tight_layout()
plt.savefig('../visualizations/STEP10_ENHANCED_1_capacity_heatmap.png', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../visualizations/STEP10_ENHANCED_2_top6_enrolment_forecasts.png', bbox_inches='tight')
plt.close()
...
plt.suptitle('Top 6 High-Demand States: Biometric Update Forecasts (6-Month Horizon)', 
             fontsize=20, fontweight='bold', y=0.995)
plt.tight_layout()
plt.savefig('../visualizations/STEP10_ENHANCED_3_top6_biometric_forecasts.png', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../visualizations/STEP10_ENHANCED_4_demand_score_ranking.png', bbox_inches='tight')
plt.close()
...
plt.savefig('../visualizations/STEP10_ENHANCED_5_comprehensive_dashboard.png', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../visualizations/STEP10_ENHANCED_6_growth_trajectory.png', bbox_inches='tight')
plt.close()
