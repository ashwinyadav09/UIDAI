...
bottleneck_pred = pd.read_csv('../results/STEP11_bottleneck_predictions.csv')
age_targeting = pd.read_csv('../results/STEP11_age_group_targeting.csv')
capacity_pred = pd.read_csv('../results/STEP11_capacity_predictions.csv')
feature_importance = pd.read_csv('../results/STEP11_feature_importance.csv')
...
plt.tight_layout()
plt.savefig('../visualizations/STEP11_1_bottleneck_prediction.png', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../visualizations/STEP11_2_age_group_targeting.png', bbox_inches='tight')
plt.close()
...
plt.savefig('../visualizations/STEP11_3_capacity_planning_dashboard.png', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../visualizations/STEP11_4_campaign_targets.png', bbox_inches='tight')
plt.close()
...
plt.savefig('../visualizations/STEP11_5_comprehensive_dashboard.png', bbox_inches='tight')
plt.close()
