...
try:
    ...
    state_enrolments = enrolment.groupby('state')['total_enrolments'].sum().reset_index()
    state_bio_updates = biometric.groupby('state')['total_bio_updates'].sum().reset_index()
    state_demo_updates = demographic.groupby('state')['total_demo_updates'].sum().reset_index()
