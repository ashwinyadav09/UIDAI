...
high_risk_states.to_csv('../results/STEP8_high_exclusion_risk_states.csv', index=False)
critical_states.to_csv('../results/STEP8_critical_intervention_states.csv', index=False)
...
plt.tight_layout()
plt.savefig('../visualizations/STEP8_biometric_compliance.png', dpi=300, bbox_inches='tight')
