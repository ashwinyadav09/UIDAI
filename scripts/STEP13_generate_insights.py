...
step6_demo = pd.read_csv('../results/STEP6_demographic_trends.csv')
...
step10_cap = pd.read_csv('../results/STEP10_ENHANCED_capacity_planning.csv')
...
plt.tight_layout()
plt.savefig('../visualizations/STEP13_01_lowest_compliance_states.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('../visualizations/STEP13_02_age_group_vulnerability.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('../visualizations/STEP13_03_state_age_vulnerability_heatmap.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('../visualizations/STEP13_04_bottleneck_predictions.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('../visualizations/STEP13_05_demand_bottleneck_scatter.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('../visualizations/STEP13_06_recommendation_priority_matrix.png', dpi=300, bbox_inches='tight')
...
plt.savefig('../visualizations/STEP13_07_executive_summary_dashboard.png', dpi=300, bbox_inches='tight')
...
# Save the report
with open('../results/STEP13_comprehensive_insights_report.txt', 'w', encoding='utf-8') as f:
